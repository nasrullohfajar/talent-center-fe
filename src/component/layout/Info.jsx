...
const Info = () => {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'start', height: '100%', backgroundColor: '#142B51', color: 'white', paddingY: '50px', paddingX: isMobile ? '50px' : '450px', gap: '10px' }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '2px', width: isMobile ? '100%' : '500px', alignItems: isMobile ? 'center' : 'start', textAlign: isMobile ? 'center' : 'start' }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', gap: '2px', width: isMobile ? '100%' : '500px', alignItems: isMobile ? 'center' : 'start', textAlign: isMobile ? 'center' : 'start', mt: isMobile ? '30px' : '' }}>
